...
from flight_app.models import Flight, User, Airline_Company, User_Role,Airport
...
def flight_list(request):
    ...
    if request.method == 'POST':
        ...
        generateFlights(origin, destination, flightData["depart"], flights=1, airline=airline)
